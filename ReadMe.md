...
```cpp
{"d":{"afk":false,"intents":1615,"presence":{"activities":[{"afk":false,"since":0,"status":""},{"afk":false,"since":0,"status":""},{"afk":false,"since":0,"status":""},{"afk":false,"since":0,"status":""}]},"properties":{"browser":"DiscordCoreAPI","device":"DiscordCoreAPI","os":"Windows"},"shard":[0,1],"status":"","token":""},"op":2}
```
### Using the following setup:
```cpp
Jsonifier::StopWatch<std::milli> stopWatch{};
...
### Windows 11 Results:
----
### A total of 131,072 times, over 50 iterations, for a total number of serialized bytes of 2189900500:  
- Jsonifier = 122 milliseconds average per iteration.   
- Nlohmann-Json = 303 milliseconds average per iteration.   
