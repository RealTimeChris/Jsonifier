...
template<typename test_type> void runTest(const jsonifier::string& testName, jsonifier::string& dataToParse, jsonifier::jsonifier_core<>& parser, bool doWeFail = true) {
