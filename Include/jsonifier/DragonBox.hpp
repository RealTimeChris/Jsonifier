...
// C++17 JSONIFIER_INLINE variables
	...
	namespace dragonbox {
		...
		namespace detail {
			...
			namespace wuint {
				...
				JSONIFIER_SAFEBUFFERS JSONIFIER_INLINE JSONIFIER_CONSTEXPR20 uint128 umul128(std::uint_least64_t x, std::uint_least64_t y) noexcept {
				...
				// integers.
				JSONIFIER_SAFEBUFFERS JSONIFIER_INLINE JSONIFIER_CONSTEXPR20 std::uint_least64_t umul128_upper64(std::uint_least64_t x, std::uint_least64_t y) noexcept {
				...
				// unsigned integer.
				JSONIFIER_SAFEBUFFERS JSONIFIER_INLINE JSONIFIER_CONSTEXPR20 uint128 umul192_upper128(std::uint_least64_t x, uint128 y) noexcept {
				...
				// unsigned integer.
				JSONIFIER_SAFEBUFFERS JSONIFIER_INLINE JSONIFIER_CONSTEXPR20 uint128 umul192_lower128(std::uint_least64_t x, uint128 y) noexcept {
		...
		namespace policy {
			...
			namespace trailing_zero {
				...
				JSONIFIER_INLINE_VARIABLE struct remove_t {
					...
					JSONIFIER_INLINE static JSONIFIER_CONSTEXPR20 unsigned_decimal_fp<DecimalSignificand, DecimalExponentType, false> on_trailing_zeros(DecimalSignificand significand,
			...
			namespace decimal_to_binary_rounding {
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_to_even_t {
					...
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_to_even_t>(), Args{}...)) delegate(SignedSignificandBits,
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_to_odd_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_to_odd_t>(), Args{}...)) delegate(SignedSignificandBits,
						Func f, Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_toward_plus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_plus_infinity_t>(), Args{}...)) delegate(
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_toward_minus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_minus_infinity_t>(), Args{}...)) delegate(
						SignedSignificandBits, Func f, Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_toward_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_zero_t>(), Args{}...)) delegate(
						SignedSignificandBits, Func f, Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_away_from_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_away_from_zero_t>(), Args{}...)) delegate(
						SignedSignificandBits, Func f, Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_to_even_static_boundary_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::nearest_always_closed_t{}, Args{}...)) delegate(SignedSignificandBits s, Func f,
						Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct nearest_toward_plus_infinity_static_boundary_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(nearest_toward_zero, Args{}...)) delegate(SignedSignificandBits s, Func f,
						Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct toward_plus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::left_closed_directed_t{}, Args{}...)) delegate(SignedSignificandBits s, Func f,
						Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct toward_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::left_closed_directed_t{}, Args{}...)) delegate(SignedSignificandBits, Func f,
						Args... args) noexcept {
				...
				JSONIFIER_INLINE_VARIABLE struct away_from_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... Args>
					JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::right_closed_directed_t{}, Args{}...)) delegate(SignedSignificandBits, Func f,
						Args... args) noexcept {
		...
		namespace detail {
			...
			template<typename FormatTraits> struct impl : private FormatTraits::format {
				...
				JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static JSONIFIER_CONSTEXPR20 return_type<SignPolicy, TrailingZeroPolicy, PreferredIntegerTypesPolicy> compute_left_closed_directed(
					signed_significand_bits<FormatTraits> s, exponent_int exponent_bits) noexcept {
					using cache_holder_type = typename CachePolicy::template cache_holder_type<format>;
					static_assert(min_k >= cache_holder_type::min_k && max_k <= cache_holder_type::max_k, "");
				...
				template<typename SignPolicy, typename TrailingZeroPolicy, typename CachePolicy, typename PreferredIntegerTypesPolicy>
				JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS static JSONIFIER_CONSTEXPR20 return_type<SignPolicy, TrailingZeroPolicy, PreferredIntegerTypesPolicy> compute_right_closed_directed(
					signed_significand_bits<FormatTraits> s, exponent_int exponent_bits) noexcept {
					using cache_holder_type = typename CachePolicy::template cache_holder_type<format>;
					static_assert(min_k >= cache_holder_type::min_k && max_k <= cache_holder_type::max_k, "");
		...
		JSONIFIER_INLINE JSONIFIER_SAFEBUFFERS JSONIFIER_CONSTEXPR20 detail::to_decimal_return_type<FormatTraits, Policies...> to_decimal_ex(signed_significand_bits<FormatTraits> s,
