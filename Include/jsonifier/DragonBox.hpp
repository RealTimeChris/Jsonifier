...
namespace jsonifier_jkj {
	namespace dragonbox {
		...
		namespace policy {
			...
			namespace decimal_to_binary_rounding {
				...
				JSONIFIER_ALWAYS_INLINE_VARIABLE struct nearest_to_even_t {
					...
					JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_to_even_t>(), arg_types{}...)) delegate(
				...
				JSONIFIER_ALWAYS_INLINE_VARIABLE struct nearest_to_odd_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_to_odd_t>(), arg_types{}...)) delegate(
						SignedSignificandBits, Func f, arg_types... args) noexcept {
				...
				JSONIFIER_ALWAYS_INLINE_VARIABLE struct nearest_toward_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_zero_t>(), arg_types{}...)) delegate(
						SignedSignificandBits, Func f, arg_types... args) noexcept {
				...
				JSONIFIER_ALWAYS_INLINE_VARIABLE struct nearest_to_even_static_boundary_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::nearest_always_closed_t{}, arg_types{}...)) delegate(
				...
				JSONIFIER_ALWAYS_INLINE_VARIABLE struct toward_plus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::left_closed_directed_t{}, arg_types{}...)) delegate(
						SignedSignificandBits s, Func f, arg_types... args) noexcept {
				...
				JSONIFIER_ALWAYS_INLINE_VARIABLE struct away_from_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::right_closed_directed_t{}, arg_types{}...)) delegate(
						SignedSignificandBits, Func f, arg_types... args) noexcept {
		...
		JSONIFIER_SAFEBUFFERS JSONIFIER_CONSTEXPR20 detail::to_decimal_return_type<FormatTraits, Policies...> to_decimal(Float x,
